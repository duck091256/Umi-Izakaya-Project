...
public class Login extends JFrame {
    ...
    public Login() {
        ...
        passwordField.setBounds(230, 160, 252, 29);
        passwordField.setBackground(new Color(223, 223, 223));
        passwordField.setForeground(Color.BLACK);
        contentPane.add(passwordField);

        PasswordText = new JLabel("Password");
        PasswordText.setBounds(230, 160, 252, 29);
        ...
        txfUsername.setBounds(230, 121, 252, 29);
        ...
        UsernameText.setBounds(230, 121, 252, 29);
        ...
        lbl_Login.setBounds(230, 200, 252, 29);
