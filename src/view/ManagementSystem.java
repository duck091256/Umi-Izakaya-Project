...
import service.FullMapFrame;
import service.MiniMapPreviewPanel;
...
//    		TableDAO.storeData();
    ...
    private void loadReceiptsData() {
        ArrayList<Bill> allReceipts = BillDAO.getInstance().loadBill();
    ...
    private void loadSessionsData() {
    	ArrayList<Session> allSessions = SessionDAO.getInstance().getAllSessions();
